...
<body>
    ...
    <main>
		...
		if(isset($_POST['submit'])){
            ...
            $sub_cat_query = "INSERT INTO `sub_category`(  `category_id`, `sub_cat`, `image`) VALUES ( '$category_id',' $sub_cat','$filename')";
    
            mysqli_query($conn,$sub_cat_query);
		...
		?>
            ...
            $sub_cat_sql = "SELECT category.category as cattitle, sub_category. * from category JOIN sub_category on sub_category.category_id = category.id";
             ...
             while($sub_cat_fetch = mysqli_fetch_assoc($sub_cat_result)){
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                       ...
                       <a  href="http://localhost/Ecommerce_website/Admin/editsubcat.php?id=<?php echo $sub_cat_fetch ['id']; ?>"><input type="submit" class="btn btn-primary" value="Edit" ></a>
